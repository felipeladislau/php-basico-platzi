...
--
-- Host: 127.0.0.1
-- Generation Time: 03-Dez-2018 às 14:45
...
INSERT INTO `categorias` (`categoria_id`, `nome`, `url`, `descricao`) VALUES
(1, 'Star Wars', 'starwars', '');
...
INSERT INTO `imagens` (`imagen_id`, `imagem_url`, `ordem`, `categoria_id`, `nome`, `descricao`) VALUES
(1, 'main.png', 1, 1, 'Moldura principal', ''),
(2, 'bb8.png', 2, 1, 'BB8', '');
