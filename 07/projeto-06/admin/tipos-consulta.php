...
<div id="page-wrapper">
	<div class="main-page">
		<div class="tables">
			<h2 class="title1">Consulta de tipos</h2>
					...
					<tbody>
						...
						<?php
							...
							foreach ($tipos as $tipo) {
								echo '<tr>
										<th scope="row"><a href="tipos-deleta.php?id='.$tipo["tipo_imovel_id"].'"><img src="images/delete.png" style="width:25px;"></a></th>
										<td>'.utf8_encode($tipo["nome"]).'</td>
										<td>'.utf8_encode($tipo["descricao"]).'</td>
									</tr>';
							}
						?>
