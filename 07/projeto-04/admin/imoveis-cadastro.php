				...
				<div class="form-three widget-shadow">
					<form class="form-horizontal">
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">Título do imóvel</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">Foto 1</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">Foto 2</label>
							<div class="col-sm-8">
								<input type="file" class="form-control1" id="focusedinput" placeholder="">
							</div>
						</div>
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">Foto 3</label>
							<div class="col-sm-8">
								<input type="file" class="form-control1" id="focusedinput" placeholder="">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8"><select name="selector1" id="selector1" class="form-control1">
								<option>Selecione o status do imovel.</option>
								<option>Aluga-se</option>
								<option>Vende-se</option>
							</select></div>
						</div>
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">Endereço do imóvel</label>
							<div class="col-sm-8">
								<input type="text" class="form-control1" id="focusedinput" placeholder="">
							</div>
						</div>
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">Valor do imóvel</label>
							<div class="col-sm-8">
								<input type="text" class="form-control1" id="focusedinput" placeholder="">
							</div>
							<div class="col-sm-2">
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">Observações</label>
							<div class="col-sm-8"><textarea name="txtarea1" id="txtarea1" cols="50" rows="4" class="form-control1"></textarea></div>
						</div>
