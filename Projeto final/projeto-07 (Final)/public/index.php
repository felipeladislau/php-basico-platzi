	...
	<div class="container">
		<div class="topbar">
			<ul class="topbar__contact">
				<li><span class="ion-ios-telephone-outline topbar__icon"></span><a href="tel:+551111112222" class="topbar__link">(11)1111-2222</a></li>
				<li><span class="ion-ios-email-outline topbar__icon"></span><a href="mailto:contato@platzi.com" class="topbar__link">contato@platzi.com</a></li>
			</ul><!-- .topbar__contact -->

			<ul class="topbar__user">
				<span class="ion-ios-person-outline topbar__user-icon"></span>
				<li><a href="../admin/" class="topbar__link">Admin</a></li>
			</ul>
		</div><!-- .topbar -->
		...
		<div class="header__main">
			<div class="header__logo">
				<a href="index.php">
					...
					<img src="images/logo.png" alt="Platzi">
				</a>
			</div><!-- .header__main -->
		...
		<div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.6">
			<ul>
				...
				<li data-index="rs-12" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/revslider/main_slider_1-2-100x50.jpeg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					...
					<!-- LAYER NR. 4 -->
					<div class="tp-caption   tp-resizeme" id="slide-12-layer-1" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-68','-68','-60','-40']" data-fontsize="['18','18','16','14']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="text" data-responsive_offset="on" data-frames='[{"delay":300,"speed":1500,"frame":"0","from":"y:top;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 5; white-space: nowrap; font-size: 18px; line-height: 22px; font-weight: 400; color: #f3f3f3; letter-spacing: 0px;font-family:Roboto;">SUPER FÁCIL E SEM BUROCRACIA </div>
	
					<!-- LAYER NR. 5 -->
					<div class="tp-caption   tp-resizeme" id="slide-12-layer-2" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']" data-fontsize="['60','60','40','26']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="text" data-responsive_offset="on" data-frames='[{"delay":300,"speed":1500,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 6; white-space: nowrap; font-size: 60px; line-height: 22px; font-weight: 900; color: #ffffff; letter-spacing: 0px;font-family:Raleway;">Saia da imobiliária com suas chaves! </div>
		...
		<div class="container">
			<div class="main-search__container">
				<section class="listing-search">
					<form action="pesquisa.php" method="get" class="" id="meuform">
						<div class="row">
							<div class="col-sm-3">
								<label for="listing-type" class="listing-search__label">Status do imóvel</label>
								<select name="listing-type" id="listing-type" class="ht-field">
									<option value="todos" selected>Todos listados</option>
									<option value="alugase">Aluga-se</option>
									<option value="vendese">Vende-se</option>
									<option value="breve">Em breve</option>
								</select>
							</div><!-- .col -->
			
							<div class="col-sm-3">
								<label for="offer-type" class="listing-search__label">Tipo do imóvel</label>
								<select name="offer-type" id="offer-type" class="ht-field">
									<option value="todos" selected>Todos listados</option>
									<option value="apartamento">Apartamento</option>
									<option value="casa">Casa</option>
									<option value="comercial">Sala comercial</option>
									<option value="rural">Chácaras ou sítios</option>
								</select>
							</div><!-- .col -->
			
							<div class="col-sm-3">
								<label for="city" class="listing-search__label">Estado</label>
								<select name="city" id="city" class="ht-field">
									<option value="todos" selected>Todo o Brasil</option>
							...
							<div class="col-sm-3">
									<input type="submit" name="enviar" value="Pesquisar" class="listing-search__btn" onclick="document.getElementById('meuform').submit();">
							</div><!-- .col -->
						</div><!-- row -->
  ...
  <div class="container">
    <div class="row">
		...
		foreach ($meusimoveis as $imovel ) {
			...
			echo '<div class="col-md-6 item-grid__container">
						<div class="listing">
							<div class="item-grid__image-container">
								<a href="imovel.php?id='.$imovel["imovel_id"].'">
									<div class="item-grid__image-overlay"></div><!-- .item-grid__image-overlay -->
									<img src="images/imoveis/'.$imovel["foto_1"].'" alt="" class="listing__img">
								</a>
								...
								<div class="listing__content">
									<div class="listing__header">
										<div class="listing__header-primary">
											<h3 class="listing__title"><a href="single_property_1.html">'.utf8_encode($imovel["titulo"]).'</a></h3>
											<p class="listing__location"><span class="ion-ios-location-outline listing__location-icon"></span>'.utf8_encode($imovel["endereco"]).'</p>
										</div><!-- .listing__header-primary -->
										<p class="listing__price">R$'.$imovel["valor"].'</p>
									</div><!-- .listing__header -->
									<div class="listing__details">
										<ul class="listing__stats">
				
										</ul><!-- .listing__stats -->
										<a href="imovel.php?id='.$imovel["imovel_id"].'" class="listing__btn">Detalhes <span class="listing__btn-icon"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="feature">
            ...
            <h3 class="feature__title">As melhroes localizações</h3>
            <p class="feature__desc">
              Encontre um imóvel perto de você, sem sair de casa.
            </p>
          </div><!-- .feature -->
        </div><!-- .col -->
        ...
        <div class="col-sm-4">
          <div class="feature">
            ...
            <h3 class="feature__title">Pesquisa rápida</h3>
            <p class="feature__desc">
              Pesquisa rapidamente os melhores imóveis da sua cidade.
            </p>
          </div><!-- .feature -->
        </div><!-- .col -->
        <div class="col-sm-4">
          <div class="feature">
            ...
            <h3 class="feature__title">Economia certa</h3>
            <p class="feature__desc">
              Aqui você encontra os melhores negocios!
            </p>
          </div><!-- .feature -->
        </div><!-- .col -->  
      </div><!-- .row -->
